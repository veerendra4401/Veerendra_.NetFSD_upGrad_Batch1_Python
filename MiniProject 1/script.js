...
// Helper functions for grading logic (also exported for testing)
            ...
            <div class="course-card">
                ...
                ${quizResults.slice(-5).map(result => `
                    <div class="quiz-history-item">
                        ...
                        <p>Grade: ${result.grade} - ${result.passed ? 'Pass' : 'Fail'}</p>
                        <progress value="${result.percentage/100}" max="1"></progress>
                    </div>
                `).join('')}
            </div>
        </div>
